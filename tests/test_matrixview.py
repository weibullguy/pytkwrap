...
class TestMatrixView(CommonWidgetTests):
    """Test class for the MatrixView."""

    widget_class = MatrixView
    ...
    def no_signal_error_handler(self, message):
        assert (
            message == "MatrixView.do_set_callbacks(): Unknown signal name "
            "'value-changed'."
        )
    ...
    def test_do_set_attributes_default(self):
        """do_set_attributes() should set the default attributes of a MatrixView when no
        WidgetAttributes."""
    ...
    def test_do_set_attributes(self):
        """do_set_attributes() should set the MatrixView attributes to the values
        passed in a WidgetAttributes dict."""
    ...
    def test_do_add_column(self):
        """do_Add_column() should add a column to the MatrixView."""
        dut = self.make_dut()
    ...
    def test_do_add_column_label(self):
        """do_set_column_headings() should add a Label widget with text and a tooltip to each column."""
        dut = self.make_dut()
        ...
        assert dut.n_columns == 1
        assert dut.n_rows == 0
        assert isinstance(dut.get_child_at(1, 0), Label)
    ...
    def test_do_add_row_label(self):
        """do_set_row_headings() should add a Label widget with text and a tooltip to
        each row."""
        dut = self.make_dut()
        ...
        assert dut.n_columns == 0
        assert dut.n_rows == 1
        assert isinstance(dut.get_child_at(0, 1), Label)
    ...
    def test_do_add_row(self):
        """do_Add_row() should add a row to the MatrixView."""
        dut = self.make_dut()
    ...
    def test_do_add_combobox_widget(self):
        """do_add_widget() should add a ComboBox widget to the cell at X,
        Y coordinates."""
        _combo = ComboBox()
        dut = self.make_dut()
        dut.do_add_column(1)
        ...
        assert dut.n_columns == 1
        assert dut.n_rows == 1
        assert isinstance(dut.do_get_widget(1, 1), ComboBox)

    @pytest.mark.integration
    def test_do_add_entry_widget(self):
        """do_add_widget() should add an Entry widget to the cell at X,
        Y coordinates."""
        _entry = Entry()
        dut = self.make_dut()
        dut.do_add_column(1)
        ...
        assert dut.n_columns == 1
        assert dut.n_rows == 1
        assert isinstance(dut.do_get_widget(1, 1), Entry)

    @pytest.mark.integration
    def test_do_add_label_widget(self):
        """do_add_widget() should add a Label widget to the cell at X,
        Y coordinates."""
        _label = Label("Test Label")
        dut = self.make_dut()
        dut.do_add_column(1)
        dut.do_add_row(1)
        ...
        assert dut.n_columns == 1
        assert dut.n_rows == 1
        assert isinstance(dut.do_get_widget(1, 1), Label)

    @pytest.mark.integration
    def test_do_add_textview_widget(self):
        """do_add_widget() should add a TextView widget to the cell at X,
        Y coordinates."""
    ...
    def test_do_get_widget(self):
        ...
        assert isinstance(dut.get_child_at(1, 1), ComboBox)
        assert isinstance(dut.get_child_at(1, 2), ComboBox)
        assert isinstance(dut.get_child_at(1, 3), ComboBox)
        assert isinstance(dut.get_child_at(1, 1), ComboBox)
        assert isinstance(dut.get_child_at(2, 1), ComboBox)
        assert isinstance(dut.get_child_at(3, 1), ComboBox)

    @pytest.mark.unit
    def test_do_remove_column(self):
        """Should remove a column from the MatrixView."""
        dut = self.make_dut()
    ...
    def test_do_remove_row(self):
        """Should remove a row from the MatrixView."""
        dut = self.make_dut()
