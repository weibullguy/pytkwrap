...
from tests.gtk3.treeview.constants import (
    EXPECTED_TREEVIEWCOLUMN_HANDLER_IDS,
...
class TestGTK3TreeViewColumn(BaseGTK3GObjectTests):
    ...
    expected_handler_id = (
        EXPECTED_GOBJECT_HANDLER_IDS | EXPECTED_TREEVIEWCOLUMN_HANDLER_IDS
    )
    expected_methods = EXPECTED_GOBJECT_METHODS + EXPECTED_TREEVIEWCOLUMN_METHODS
    expected_properties = EXPECTED_TREEVIEWCOLUMN_PROPERTIES
