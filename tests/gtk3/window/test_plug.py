"""Test module for the GTK3Plug class.
...
from pytkwrap.gtk3.window import GTK3Plug
...
class TestGTK3Plug(BaseGTK3GObjectTests):
    """Test class for the GTK3Plug class."""

    widget_class = GTK3Plug
